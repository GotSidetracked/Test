...
public class MeshSerializerSurrogate : ISerializationSurrogate
{
	// http://wiki.unity3d.com/index.php/MeshSerializer2 
	...
	{
		//Write
		info.AddValue("Mesh", WriteMesh((Mesh)obj, true));
	}


	public object SetObjectData(object obj, SerializationInfo info, StreamingContext context, ISurrogateSelector selector)
	{
		obj = ReadMesh((byte[])info.GetValue("Mesh", typeof(byte[])));
		return obj;
		//Read
	}
